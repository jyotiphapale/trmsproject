...
<option value="ssc">SSC Marksheet</option>
<option value="hsc">HSC Marksheet</option>
<option value="dfym">Degree First Year Marksheet</option>
<option value="dsym">Degree Second Year Marksheet</option>
<option value="dtym">Degree Third Year Marksheet</option>
<option value="pgd">Post Graduation Documents</option>
